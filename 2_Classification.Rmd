...
&= \beta f(x) \left(1 - f(x) \right)(1 - 2f(x)) \\
&= \beta f(x) \left(1 - f(x) \right) \left[1 - \frac{2}{1 + \exp(- \beta_{0} - \beta x)} \right] \\
&= \beta f(x) \left(1 - f(x) \right) \left[\frac{\exp(- \beta_{0} - \beta x) - 1}{1 + \exp(- \beta_{0} - \beta x)} \right] \\
&= \beta \frac{f(x) \left(1 - f(x) \right)}{1 + \exp(- \beta_{0} - \beta x)}[\exp(- \beta_{0} - \beta x) - 1] \\
\therefore f^{\prime\prime}(x) &= \beta^{2} \frac{f(x) \left(1 - f(x) \right)}{1 + \exp(- \beta_{0} - \beta x)}[\exp(- \beta_{0} - \beta x) - 1] 
\end{aligned}
$$

Note that $\beta^{2} \frac{f(x) \left(1 - f(x) \right)}{1 + \exp(- \beta_{0} - \beta x)} > 0$. Thus $f(x)$ is convex if and only if:
$$
\begin{aligned}
